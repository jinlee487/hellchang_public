...
<form action="updateProfile" method="post" style="border:1px solid #ccc" name="regform">
  <div class="container bounce-in-left">
   ...
   <p>Please fill in this form to update an account.</p>
    ...
    <input type="text" placeholder="Name" name="psw-repeat" class="input" value="${myInfo.name }" required><br>
    ...
    <input type="text" placeholder="Ex 010-1234-5678" name="psw-repeat" class="input" value="${myInfo.phone}" required><br>
    
	
	<label for="location" class="int"><b>location</b></label><br>
	<input type="text" name="zipcode" id="zipcode" size="7" value="${myInfo.zipcode }" onClick="sample4_execDaumPostcode()" readonly placeholder="우편번호 검색" required>
	<br>
    <input type="text" name="address" id="address" value="${myInfo.address }" readonly placeholder="주소입력해주세요" required><br>
    <input type="text" name="address1" id="address1" value="${myInfo.address1 }" placeholder="상세주소를 입력해주세요" required>
    <br>
    <label class="int">
